...
$.ajax({
  ...
  data: {
    key: 'YGOBZ-ZOA2H-5LWDY-WY5JC-EGRRO-JUBQ3',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
  success: function (res) {
    ipLoacation = res;
    //alert("lng:"+res.result.location.lng);
    //alert("lat:"+res.result.location.lat);
  }
})
...
function showWelcome() {
  ...
  console.log(ipLoacation.result.location.lng,ipLoacation.result.location.lat);
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by LuckyBoy🥝 %c 你正在访问LuckyBoy🥝の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| LuckyBoy🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('LuckyBoy🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("03/25/2023 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='/assets/111.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='/assets/222.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(/img/bg/bg1.webp);
    --darkmode-bg:url(/img/bg/yuanshen1.webp);
    --mobileday-bg: url(/img/bg/snow.webp);
    --mobilenight-bg: url(/img/bg/mb8.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/bg/bg2.webp)" class="imgbox" onclick="changeBg('url(/img/bg/bg2.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/bg/bg1.webp)" class="imgbox" onclick="changeBg('url(/img/bg/bg1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/bg/mc1.webp)" class="imgbox" onclick="changeBg('url(/img/bg/mc1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/bg/mb4.webp)" class="pimgbox" onclick="changeBg('url(/img/bg/mb4.webp)')"></a></div>
              </div>
            </details>
